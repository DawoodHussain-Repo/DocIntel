"""Document ingestion pipeline with heading-aware chunking and vector indexing."""
import hashlib
...
from core.pdf_extraction import extract_pdf_elements
...
def _index_chunks(
    ...
    """Embed and index normalized document chunks into ChromaDB."""
...
def process_pdf(file_path: str, filename: str, chroma_client: Any) -> Dict[str, Any]:
    ...
    valid_elements = extract_pdf_elements(file_path, filename)
    ...
    return _index_chunks(chunks, filename, chroma_client)
